...
frappe.query_reports["Monthly Attendance Report"] = {
	...
	formatter: function (value, row, column, data, default_formatter) {
		...
		if (!summarized_view) {
			const non_day_fields = ["ward", "branch", "employee", "employee_name", "department", "designation", "month_year", "total_present", "total_absent", "total_leaves", "shift"];
			if (!non_day_fields.includes(column.fieldname) && column.fieldname !== frappe.scrub(group_by)) {
